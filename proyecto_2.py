...
logo = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\SARS-CoV-2_without_background.png')
if choose == "Inicio":
    ...
    profile = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\newplot.png')
...
if choose == "Camas UCI":
    ...
    profile = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\Total_camas2.box.jpg')
...
if choose == "Ocupación":
    ...
    profile = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\ranking_estados.jpg')
    st.image(profile, width=700 )
...
if choose == "Conclusiones":
    ...
    profile = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\deaths_covid.jpg')
    st.image(profile, width=700 )

    st.subheader('Falta de personal medico')
    profile = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\falta_de_personal.jpg')
    st.image(profile, width=700 )

    st.subheader('Relación entre muertes y falta de personal medico')
    profile = Image.open(r'C:\Users\x\OneDrive\Escritorio\Agus\Henry DATA 02\Proyecto P2\relacion_muertes_falta_de_personal.jpg')
    st.image(profile, width=700 )
